...
pixieweb provides a consistent, pipe-friendly R interface to all these
APIs. It follows the same design principles as
...
table defines its own set of dimensions. pixieweb calls these
**variables**.
...
| Function                                                                                     | Purpose                        |
|----------------------------------------------------------------------------------------------|--------------------------------|
| [`table_search()`](https://lchansson.github.io/pixieweb/reference/table_search.md)           | Filter by regex (client-side)  |
| [`table_describe()`](https://lchansson.github.io/pixieweb/reference/table_describe.md)       | Print human-readable summaries |
| [`table_minimize()`](https://lchansson.github.io/pixieweb/reference/table_minimize.md)       | Remove constant columns        |
| [`table_extract_ids()`](https://lchansson.github.io/pixieweb/reference/table_extract_ids.md) | Extract ID vector for piping   |
